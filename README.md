...
Site: https://www.march-arena-taupe.vercel.app (bracket + “View the code”; no hosted sim).
...
5. **Leaderboard (optional)** — Convex-backed aggregation when you run sims that call `saveSimulationResults`

## Stack

- **Next.js 16** (App Router) + **React 19**
- **OpenRouter** + **Anthropic** for structured game picks (BYOK)
- **Convex** for leaderboard and survivor pool persistence
